...
const HistorySlider = () => {
  ...
  const historyData: HistoryItem[] = [
    ...
    {
      year: "1384",
      title: "خریداری زمین و شروع ساخت",
      content:
    ...
    {
      year: "1384",
      title: "پایان ساخت بنای بیمارستان",
      content:
    ...
    {
      year: "1390",
      title: "بهره‌برداری رسمی از بیمارستان",
      content:
    ...
    },
    {
      ...
      content:
        "شعار و بیانیه رسمی بیمارستان نیکان «در ستایش زندگی» است.\n" +
          "ما در نیکان، زندگی را گرامی می‌داریم و سلامت را با عشق و احترام همراه می‌سازیم. ما باور داریم هر لحظه زندگی ارزشمند است و رسالت ما، نه تنها درمان بیماری‌ها، بلکه حمایت از امید، شادی و آرامش بیماران و همراهانشان است. لذا می‌کوشیم تا زندگی را در تمامی لحظاتش پاس بداریم و فضایی سرشار از مهر و اعتماد بیافرینیم. \n" +
          "*زندگی زیباست و ما این زیبایی را با شما سهیم می‌شویم.*",
      image: "/images/aboutNikan.svg",
    },
  ];
                ...
                <SwiperSlide key={index}>
                  <div className="flex lg:justify-end justify-center items-center">
                    <div className="lg:max-w-[496px] max-w-[413px] flex flex-col lg:pr-[27px] lg:gap-y-6 gap-y-3 lg:px-0 px-5">
                      <span className="text-end lg:text-[38px] text-[30px] text-[#D8D8D8] font-thin">
                        تاریخچه نیکان
                      </span>
