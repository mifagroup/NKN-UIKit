...
const branches = [
  ...
  },
  {
    ...
    desc: "تهران، اتوبان همت به سمت غرب، نرسیده به میدان المپیک، روبروی پارک جوانمردان، بیمارستان نیکان غرب ",
  },
  {
    id: 3,
    title: "بیمارستان نیکان سپید",
    desc: "تهران، اتوبان شهید بابایی، بلوار بهار، خیابان لاله، بیمارستان نیکان سپید ",
  },
  {
    id: 4,
    title: "بیمارستان مرکز جراحی محدود نیکان",
    desc: "اقدسیه – ابتدای بلوار ارتش – ورودی اراج – خیابان ٢٢ بهمن – شماره ٦ ",
  },
];
